...
class Help:
    ...
    def __init__(self):
        ...
        print('\n')
        print("Criar um job:")
        print('  $ jenkins-automation --create=job --name=teste --environment=dev --repo=stash.pontoslivelo.com.br/scm/tst/meu-repo.git')
        print('\n')
        print("Deleta um job:")
        print('  $ jenkins-automation --delete=job --name=teste1,teste2,testeN')
        print('\n')
